...
public class MuleSchemaRepository {
    ...
    private static final String MULE_EE_NS = "http://www.mulesoft.org/schema/mule/ee/core";
    private static final String MULE_EE_SCHEMA_LOCATION = "http://www.mulesoft.org/schema/mule/ee/core/current/mule-ee.xsd";

    private static final String MULE_NS = "http://www.mulesoft.org/schema/mule/core";
    private static final String MULE_CORE_SCHEMA_LOCATION = "http://www.mulesoft.org/schema/mule/core/current/mule-core.xsd";
    private static final String MULE_SCHEMA_LOCATION = "http://www.mulesoft.org/schema/mule/core/current/mule.xsd";

    private static final String MODULE_NS = "http://www.mulesoft.org/schema/mule/module";
    private static final String MODULE_SCHEMA_LOCATION = "http://www.mulesoft.org/schema/mule/module/current/mule-module.xsd";

    private static final String DOMAIN_NS = "http://www.mulesoft.org/schema/mule/domain";
    private static final String DOMAIN_SCHEMA_LOCATION = "http://www.mulesoft.org/schema/mule/domain/current/mule-domain.xsd";

    private static final String DOCUMENTATION_NS = "http://www.mulesoft.org/schema/mule/documentation";
    private static final String DOCUMENTATION_SCHEMA_LOCATION = "http://www.mulesoft.org/schema/mule/mule-documentation.xsd";

    private static final String SPRING_BEANS_NS = "http://www.springframework.org/schema/beans";
    private static final String SPRING_BEANS_SCEMA_LOCATION = "http://www.springframework.org/schema/beans/spring-beans-3.0.xsd";

    private static final String MULE_SCHEMA_DOC_SCHEMA_LOCATION = "http://www.mulesoft.org/schema/mule/schemadoc/current/mule-schemadoc.xsd";
    private static final String MULE_SCHEMA_DOC_NS = "http://www.mulesoft.org/schema/mule/schemadoc";
    ...
    public Optional<SchemaInformation> loadSchemaFromCoordinate(Project project, String groupId, String artifactId, String version, String classifier) {
        ...
        } else if (groupId.equals(COM_MULESOFT_MUNIT) && artifactId.equals(MUNIT_RUNNER)) { //was: MUNIT_TOOLS, why????
