...
public class RestSdkPaths {
  ...
  public static final YamlPath SAMPLE_DATA_URI_PARAMETER_PATH = YamlPath.DOCUMENT.child("sampleData").any().child("definition").child("request").child("binding").any().any().child("value");
  public static final YamlPath OPERATION_VALUE_PROVIDERS_PATH = YamlPath.DOCUMENT.child("endpoints").any().child("operations").any().child("expects").child("body").any().any().child("valueProvider").child("items").any().any().child("expression");
  public static final YamlPath OPERATION_REQUEST_BODY_PATH = YamlPath.DOCUMENT.child("operations").any().child("request").child("body").child("expression");
  ...
  public static final YamlPath TEST_CONNECTION_PATH = YamlPath.DOCUMENT.child("security").child("*").child("testConnection").child("responseValidation").any().child("expression");
  public static final YamlPath API_PATH = YamlPath.DOCUMENT.child("apiSpec").child("url");

  public static final YamlPath PARAMETERS_SELECTOR_FROM_BODY_REQUEST_PATH = YamlPath.PARENT.parent().parent().child(RestSdkInputOutputTypesProvider.PARAMETERS_KEY);
  public static final YamlPath PARAMETERS_SELECTOR_FROM_QUERY_PARAMETER_PATH = YamlPath.PARENT.parent().parent().parent().child(RestSdkInputOutputTypesProvider.PARAMETERS_KEY);
  public static final YamlPath PARAMETERS_SELECTOR_PATH = YamlPath.PARENT.parent().parent().parent().child(RestSdkInputOutputTypesProvider.PARAMETERS_KEY);
  public static final YamlPath PARAMETERS_SELECTOR_FROM_ITEMS_PATH = YamlPath.PARENT.parent().parent().child(RestSdkInputOutputTypesProvider.PARAMETERS_KEY);
  public static final YamlPath PARAMETERS_SELECTOR_FROM_ROOT_SAMPLE_DATA_PATH = YamlPath.PARENT.parent().parent().parent().parent().parent().child(RestSdkInputOutputTypesProvider.PARAMETERS_KEY);
  public static final YamlPath RELATIVE_OPERATION_BASE_FROM_REQUEST_PATH = YamlPath.PARENT.parent().child("base");
  public static final YamlPath RELATIVE_OPERATION_BASE_FROM_BODY_EXPRESSION_PATH = YamlPath.PARENT.parent().parent().child("base");
}
