...
public class RestSdkPaths {
  ...
  public static final SelectionPath TRIGGERS_BINDING_VALUE = SelectionPath.DOCUMENT.child("triggers").any().child("binding").any().any().child("value");
  public static final SelectionPath TRIGGERS_BINDING_BODY_EXPRESSION = SelectionPath.DOCUMENT.child("triggers").any().child("binding").any().child("expression");
  public static final SelectionPath TRIGGERS_WATERMARK_PATH = SelectionPath.DOCUMENT.child("triggers").any().child(RestSdkInputOutputTypesProvider.WATERMARK_KEY).child("extraction").child("expression");
  public static final SelectionPath TRIGGERS_ITEMS_PATH = SelectionPath.DOCUMENT.child("triggers").any().child("items").child("extraction").child("expression");
  public static final SelectionPath TRIGGERS_SAMPLE_DATA_PATH = SelectionPath.DOCUMENT.child("triggers").any().child("sampleData").child("transform").child("expression");
  ...
  public static final SelectionPath TEST_CONNECTION_PATH = SelectionPath.DOCUMENT.child("security").child("*").child("testConnection").child("responseValidation").any().child("expression");
  ...
  public static final SelectionPath PARAMETERS_SELECTOR_PATH = SelectionPath.PARENT.parent().parent().parent().child(RestSdkInputOutputTypesProvider.PARAMETERS_KEY);
